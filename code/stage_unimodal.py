...
def run_unimodal_baselines(st_bin_train, st_bin_val, st_trans_train, st_trans_val):
    """
    Train and evaluate both unimodal baselines.

    Returns:
        unimodal_bin_acc: Validation accuracy for binary baseline
        unimodal_trans_acc: Validation accuracy for transform baseline
    """
    print("\n" + "=" * 60)
